...
- **Resolved false positive (docs-2pxg):** seven_day at 1.0% utilization, margin_hrs=-159.1h, hrs_left=166.5h. Extreme false positive — at 1% utilization with 99% headroom to the 90% ceiling, the window cannot be at cutoff risk. Alert created 2026-04-16; the deeply negative margin at near-zero utilization indicates a corrupted state or measurement anomaly, not an actual capacity crisis. The 50% utilization threshold should have suppressed this alert automatically.
